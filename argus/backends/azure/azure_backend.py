...
class BaseAzureBackend(base.CloudBackend):
    ...
    def __init__(self, name=None, userdata=None, metadata=None,
        ...
        self._azure_client =  azure_client.AzureClient(CONFIG.azure.subscription_id,
    ...
    def internal_instance_id(self):
        ...
        """
        return self._azure_client._vm_name
    ...
    def instance_password(self):
        ...
        return self._azure_client._vm_password
    ...
    def instance_server(self):
        ...
        return {'name': self._azure_client._vm_name, 'id': self._azure_client._vm_name}
